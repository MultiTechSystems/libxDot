...
#ifndef __CHANNEL_PLAN_AS923_JAPAN2_H__
#define __CHANNEL_PLAN_AS923_JAPAN2_H__

#include "ChannelPlan_AS923.h"

namespace lora {

    class ChannelPlan_AS923_Japan2: public lora::ChannelPlan_AS923 {
        public:
            /**
             ...
             */
            ChannelPlan_AS923_Japan2();
            ChannelPlan_AS923_Japan2(Settings* settings);
            ChannelPlan_AS923_Japan2(SxRadio* radio, Settings* settings);

            /**
             * ChannelPlan destructor
             */
            virtual ~ChannelPlan_AS923_Japan2();
...
#endif //__CHANNEL_PLAN_AS923_JAPAN2_H__
